...
class PrintModal extends React.PureComponent {
  ...
  render() {
    ...
    const customPagesLabelElement = <input ref={this.customInput} className="form-control" type="text" placeholder={t('message.customPrintPlaceholder')} onFocus={this.onFocus}/>;
